...
[use the app here](https://home-liart-chi.vercel.app/) **Primary changes are in /lib/chat/actions.tsx, model.ts ** Forked from (vercel ai-chatbot) [https://github.com/vercel/ai-chatbot]
